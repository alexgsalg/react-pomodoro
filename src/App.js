...
function App() {
  ...
  const handleChanges = () => {
    ...
    document.documentElement.style.setProperty('--font', isFont + ', sans-serif');
    ...
    <div className="app">
      ...
      <div className="timer">
        <div className="timer_inner">
          <svg className="timer__circle" width="340" height="340" viewBox="0 0 340 340" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className={`modal ${isModalOpen ? "open" : ''}`}>
        <div className="modal_inner">
          ...
          <div className="modal_header">
            ...
            <svg onClick={handleModal} xmlns="http://www.w3.org/2000/svg" width="14" height="14">
              <path fill="#1E213F" d="M11.95.636l1.414 1.414L8.414 7l4.95 4.95-1.414 1.414L7 8.414l-4.95 4.95L.636 11.95 5.586 7 .636 2.05 2.05.636 7 5.586l4.95-4.95z" opacity=".5" />
            </svg>
          </div>
          ...
          <div className="modal_body">
              ...
              <ul className="modal__content full_line">
                <li className="list_timer">
                  ...
                  <div className="content_time">
                    <input className="content_time__number" type="text" name="pomodoro" id="timer_pomo" readOnly value={pomo} />
                    <div className="content_time__arrows">
                      {/* Arrow UP */}
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="7"
                        onClick={() => { setPomo(pomo === 60 ? 60 : pomo + 5) }}>
                        <path fill="none" opacity=".25" stroke-width="2" d="M1 6l6-4 6 4" />
                      </svg>
                      {/* Arrow DOWN */}
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="7"
                        onClick={() => { setPomo(pomo === 0 ? 0 : pomo - 5) }}>
                        <path fill="none" opacity=".25" stroke-width="2" d="M1 1l6 4 6-4"
                        />
                      </svg>
                    </div>
                  </div>
                ...
                <li className="list_timer">
                  ...
                  <div className="content_time">
                    <input className="content_time__number" type="text" name="shortBreak" id="timer_short" readOnly value={shortBreak} />
                    {/* <p className="content_time__number">{shortBreak}</p> */}
                    <div className="content_time__arrows">
                      {/* Arrow UP */}
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="7"
                        onClick={() => { setShortBreak(shortBreak === 60 ? 60 : shortBreak + 2) }}>
                        <path fill="none" opacity=".25" stroke-width="2" d="M1 6l6-4 6 4" />
                      </svg>
                      {/* Arrow DOWN */}
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="7"
                        onClick={() => { setShortBreak(shortBreak === 0 ? 0 : shortBreak - 2) }}>
                        <path fill="none" opacity=".25" stroke-width="2" d="M1 1l6 4 6-4" />
                      </svg>
                    </div>
                  </div>
                ...
                <li className="list_timer">
                  ...
                  <div className="content_time">
                    <input className="content_time__number" type="text" name="longBreak" id="timer_long" readOnly value={longBreak} />
                    {/* <p className="content_time__number">{longBreak}</p> */}
                    <div className="content_time__arrows">
                      {/* Arrow UP */}
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="7"
                        onClick={() => { setLongBreak(longBreak === 60 ? 60 : longBreak + 2) }}>
                        <path fill="none" opacity=".25" stroke-width="2" d="M1 6l6-4 6 4" />
                      </svg>
                      {/* Arrow DOWN */}
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="7"
                        onClick={() => { setLongBreak(longBreak === 0 ? 0 : longBreak - 2) }}>
                        <path fill="none" opacity=".25" stroke-width="2" d="M1 1l6 4 6-4" />
                      </svg>
                    </div>
                  </div>
            ...
            <div className="modal_section">
              ...
              <ul className="modal__content">
                <li className="list_font">
                  <label className="radio" onClick={() => { setFont("Kumbh Sans") }}>
                    <input type="radio" defaultChecked name="fontSetter" />
                    <span className="checkround">Aa</span>
                  </label>
                </li>
                <li className="list_font">
                  <label className="radio" onClick={() => { setFont("Roboto Slab") }}>
                    <input type="radio" name="fontSetter" />
                    <span className="checkround">Aa</span>
                  </label>
                </li>
                <li className="list_font">
                  <label className="radio" onClick={() => { setFont("Space Mono") }}>
                    <input type="radio" name="fontSetter" />
                    <span className="checkround">Aa</span>
                  </label>
                </li>
            ...
            <div className="modal_section">
              ...
              <ul className="modal__content">
                <li className="list_color active"
                  onClick={() => { setColor('#f87070') }}>
                  <label className="radio" onClick={() => { setColor('#f87070') }}>
                    <input type="radio" defaultChecked name="colorSetter" />
                    <span className="checkv red"></span>
                  </label>
                </li>
                <li className="list_color active"
                  onClick={() => { setColor('#70f3f8') }}>
                  <label className="radio" onClick={() => { setColor('#70f3f8') }}>
                    <input type="radio" name="colorSetter" />
                    <span className="checkv magenta"></span>
                  </label>
                </li>
                <li className="list_color active"
                  onClick={() => { setColor('#d881f8') }}>
                  <label className="radio" onClick={() => { setColor('#d881f8') }}>
                    <input type="radio" name="colorSetter" />
            ...
            <button className="btn modal__btn" onClick={handleChanges}>Apply</button>
